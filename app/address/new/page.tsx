  ...
  return (
    <div className="min-h-screen pr-[160px] pt-[100px] relative">
      ...
      {showSuccess ? (
        ...
        // DEĞİŞİKLİK 1: Form kapsayıcısının ebeveynine (bir üst div'e) uygulanacak
        // Eklenecek sınıflar: flex flex-col min-h-[calc(100vh-100px)]
        <div className="ml-[480px] flex flex-col min-h-[calc(100vh-100px)]"> {/* Bu satır güncellendi */}
          {/* 
            DEĞİŞİKLİK 2: Doğrudan form kapsayıcısına (beyaz div'e) uygulanacak
            Kaldırılacak sınıf: h-[800px]
            Eklenecek sınıf: flex-grow
          */}
          <div className="w-[500px] bg-white mx-auto relative rounded-lg p-8 flex-grow"> {/* Bu satır güncellendi, h-[800px] kaldırıldı, flex-grow eklendi */}
            <div className="mb-8">
            ...
            {/* Save button */}
            {/* Butonun her zaman en altta kalmasını sağlamak için (eğer form içeriği kısaysa),
                form içeriği alanını da flex-col yapıp butona veya butonun kapsayıcısına mt-auto eklemeniz gerekebilir.
                Şimdilik bu değişiklikler beyaz kutunun uzamasını sağlıyor. Buton konumu bir sorun olursa, bu ayrı bir ayarlamadır. */}
            <button
              onClick={handleSave}
